...
resource "aws_key_pair" "my_key_pair" {
  ...
  public_key = file("~/.ssh/id_ed25519.pub")  # Replace with your own public key file
}
...
resource "aws_instance" "web_server" {
  ...
  subnet_id              = "subnet-0d3b50915822bc742"  # Replace with your subnet ID
